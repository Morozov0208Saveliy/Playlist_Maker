...
import com.example.playlistmakerfirstproject.audioplayer.presentation.main.RootActivity
import com.example.playlistmakerfirstproject.databinding.FragmentPlaylistCreationBinding
...
class PlaylistCreationFragment : Fragment() {
    ...
    private suspend fun editPlaylist(playlist: Playlist) {
        ...
        val updatedIdOfTracks =
            if (playlist.idOfTracks?.isEmpty() == true) null else playlist.idOfTracks
        val updatedNumberOfTracks =
            if (playlist.numberOfTracks == 0) null else playlist.numberOfTracks
